#!/usr/bin/env python3
"""
Check if AMD broke support ($234.40) on Oct 21, 2025
"""
import json
...
# AMD scanner setup
support_level = 234.40
resistance_level = 242.88
previous_close = 240.87

print("="*80)
print("AMD SUPPORT BREAK ANALYSIS - Oct 21, 2025")
print("="*80)
...
# Find all AMD tick files
tick_files = sorted(glob.glob("data/ticks/AMD_20251021_*.json"))
...
# Support analysis
print("="*80)
print("SUPPORT BREAK ($234.40) ANALYSIS")
print("="*80)
...
# Resistance analysis
print("="*80)
print("RESISTANCE BREAK ($242.88) ANALYSIS")
print("="*80)
